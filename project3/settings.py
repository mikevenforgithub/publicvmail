...
ALLOWED_HOSTS = ['127.0.0.1', 'myvmail.herokuapp.com']
...
MEDIA_ROOT = os.path.join(BASE_DIR, 'mail/static/images')

STATICFILES_DIRS = (os.path.join(BASE_DIR, 'mail/static/images'),)
